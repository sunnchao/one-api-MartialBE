  ...
  return (
    <div className="relative h-screen flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-4">Chirou API</h1>
        <p className="text-xl sm:text-2xl md:text-3xl text-gray-200 mb-8">企业级AI接口调用平台</p>

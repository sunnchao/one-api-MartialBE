...
func RelayOnly(c *gin.Context) {
	...
	model.RecordConsumeLog(c.Request.Context(), c.GetInt("id"), c.GetInt("channel_id"), 0, 0, "", c.GetString("token_name"), c.GetInt("token_id"), 0, "中继:"+path, requestTime, false, false, nil, c.ClientIP())

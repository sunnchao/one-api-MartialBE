...
func GetStatus(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		...
		"data": gin.H{
			...
			"linux_do_client_id":        config.LinuxDoClientId,
			...
			"NationalDayPromoEnabled":   config.NationalDayPromoEnabled,
			"NationalDayPromoRate":      config.NationalDayPromoRate,
			"NationalDayPromoStartDate": config.NationalDayPromoStartDate,
			"NationalDayPromoEndDate":   config.NationalDayPromoEndDate,
		},
	})
}
